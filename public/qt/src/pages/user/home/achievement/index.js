    ...
    return (
      <section className="userInfo-right-home-achievement">
        ...
        <section className="userInfo-right-home-achievement-content">
          <section>
            <article>
              <font>{likeNum}　次被赞<Icon type="like-o" style={{color: 'rgb(82, 196, 26)'}}/></font>
              <font>更多</font>
            </article>
          ...
          <section>
            <article>
              <font>{dislikeNum}　次被讨厌<Icon type="dislike-o" style={{color: '#ff4d4f'}} /></font>
              <font>更多</font>
            </article>
            <div className="likes-list">
              <span>
          ...
          <section>
            <article>
              <font>{contributeNum}　次贡献<Icon type="upload" /></font>
              <font>更多</font>
            </article>
          ...
          <section>
            <article>
              <font>{testNum}　次试题测试<Icon type="form" /></font>
              <font>更多</font>
            </article>
            <div className="likes-list contribute-list">
              <span>
